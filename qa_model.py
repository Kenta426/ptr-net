...
class AttentionQA(object):
    def __init__(self, n_pointers=1, batch_size=100, seq_length=45, q_length = 5, learning_rate=0.001,
        ...
        with tf.variable_scope('qa_alignment'):
            ...
            attention_cell = tf.contrib.seq2seq.AttentionWrapper(qa_cell, attention)
        ...
        with tf.variable_scope('encoder'):
            ...
            self.encoder_outputs, _ = tf.nn.dynamic_rnn(enc_cell, self.qa_outputs.rnn_output, self.input_lengths, dtype=tf.float32)
